...
\todo{TF a histone marks jsou jen nejčastější případy využití této metody, ale ChIP-seq obecně může detekovat jakékoli proteiny asociované s chromatinem (replikační, reparační proteiny atd., remodelery chromatinu....)}
...
\todo{v tomto textu vubec nejsou odkazy na literaturu. Je potreba citovat alespon nejake review o ChIP-seq}
