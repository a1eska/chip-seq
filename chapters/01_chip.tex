...
%Nonetheless, the method has its limitations.
...
%Various ChIP technologies have been used to map a large number of protein binding sites along the genome. 
%Microarray techniques measure the expression of many genes simultaneously but also produce a large number of false positives. 
